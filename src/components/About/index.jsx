...
import { SiPrisma, SiMysql, SiMongodb, SiNuxtdotjs } from "react-icons/si";
                ...
                <div className="mt-32 flex flex-col items-center space-y-7 ">
                    ...
                    <div className=" grid grid-cols-4 justify-items-center w-full ">
                        <div className=" flex flex-col gap-2 justify-center items-center aspect-square max-w-[112px] w-full h-full  rounded-xl m-0 p-0 hover:bg-white hover:text-black transition-all duration-300 ease-in-out">
                            <SiNuxtdotjs className="aspect-square max-w-[52px] w-full h-[52px]" />
                            <p className=" bottom-2 left-7 font-bold text-xs sm:text-base">NuxtJS</p>
                        </div>
                        <div className=" flex flex-col gap-2 justify-center items-center aspect-square max-w-[112px] w-full h-full  rounded-xl m-0 p-0 hover:bg-white hover:text-black transition-all duration-300 ease-in-out">
                            <IoLogoVue className="aspect-square max-w-[52px] w-full h-[52px]" />
                            <p className=" bottom-2 left-7 font-bold text-xs sm:text-base">VueJS</p>
                        </div>
                        <div className=" flex flex-col gap-2 justify-center items-center aspect-square max-w-[112px] w-full h-full  rounded-xl m-0 p-0 hover:bg-white hover:text-black transition-all duration-300 ease-in-out">
