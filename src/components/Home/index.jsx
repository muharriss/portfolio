...
const Home = () => {
    ...
    return (
        <div >
            ...
            <div className={`fixed h-dvh w-full -z-10 bg-[url('/bg.webp')] bg-cover bg-center`} >
            ...
            <div className={`fixed h-dvh w-full -z-10 ${!initialized ? "backdrop-blur-md bg-black bg-opacity-[82%] " : ""}  ${isBlurred ? "backdrop-blur-md bg-black bg-opacity-[82%]  " : ""}  transition-all duration-300`} />
        </div>
    )
}
